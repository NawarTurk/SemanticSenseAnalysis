...
# Folder & file names
raw_data_folder = '../data/0_raw_data'
ready_to_transform_folder = '../data/1_ready_to_transform'
ready_to_process_folder = '../data/2_ready_to_process'
result_folder = '../data/3_results'
...
def create_required_directories():
    ...
    directories = [
        '../data/1_ready_to_transform',
        '../data/2_ready_to_process/binary',
        '../data/3_results/binary/contingency_tables',
        '../data/3_results/binary/expected_tables',
        '../data/3_results/summary_report'
    ]

    # Base directory (adjust this path as needed, e.g., use an absolute path)
    base_directory = './'
...
def generate_csv(matrix_value_df, title):
    ...
    """
    directory = f'./{result_folder}/{binary_folder}/{analysis_value_matrices_folder}/{csv_files_folder}'
    file_path = f'{directory}/{title}.csv'
